package com.umang.uber.matching.config;
...
/** Consumes ride-requests; produces trip-events (TripMatchedEvent). Retry + DLT on poison records. */
@Configuration
@EnableKafka
public class KafkaConfig {
    ...
    public NewTopic tripEventsTopic() {
        return TopicBuilder.name(KafkaTopics.TRIP_EVENTS).partitions(3).replicas(1).build();
    }
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> stringListenerFactory(
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "matching-service");
