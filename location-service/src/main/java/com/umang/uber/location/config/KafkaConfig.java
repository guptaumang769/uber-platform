package com.umang.uber.location.config;
...
/** Consumer-only wiring for driver-locations, with retry + DLT on poison records. */
@Configuration
@EnableKafka
public class KafkaConfig {
    ...
    // A String KafkaTemplate is needed by the DLT recoverer.
    @Bean
