package com.umang.uber.trip.config;
...
/**
 * Consumes trip-events (TripMatchedEvent) and produces trip-events (TripStatusEvent via the
 * outbox). Retry + DLT on poison records so one bad message can't wedge the consumer.
 */
@Configuration
@EnableKafka
public class KafkaConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> stringListenerFactory(
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "trip-service");
